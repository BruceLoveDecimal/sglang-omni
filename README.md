...
| **Apple Silicon** | Experimental | Qwen3-ASR runs through native MLX or Torch MPS on macOS arm64; [Nemotron 3.5 ASR](./docs/cookbook/nemotron3_5_asr.md#apple-silicon-mlx) supports native MLX offline transcription and Torch MPS inference. Install with [`install.sh`](./install.sh) and follow the [Qwen3-ASR guide](./docs/cookbook/qwen3_asr.md#apple-silicon-mlx). |
